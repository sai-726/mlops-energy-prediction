"""
Model 2 Alternative: Gradient Boosting (scikit-learn) Training with MLflow

This script trains a Gradient Boosting model as an alternative to LightGBM.
"""
...
def train_model(X_train, y_train):
    ...
    print(f"[OK] Model trained with {params['n_estimators']} estimators")
    return model, params
...
def create_plots(model, X_train, y_test, y_test_pred):
    ...
    plt.tight_layout()
    plot_path = "gradient_boosting_plots.png"
...
def main():
    print("=" * 70)
    print("MODEL 2: GRADIENT BOOSTING TRAINING")
    print("=" * 70)
    ...
    with mlflow.start_run(run_name="gradient_boosting_model"):
        ...
        pred_path = "gradient_boosting_predictions.csv"
        ...
        mlflow.register_model(model_uri, "GradientBoosting_Energy_Model")
